...
#import "NXLNetworkHelper.h"

static NXLNetworkHelper* sharedObj = nil;

@interface NXLNetworkHelper()
{
    Reachability *_reach;
    NSInteger _index;
}
...
@implementation NXLNetworkHelper

+ (NXLNetworkHelper*) sharedInstance
{
    @synchronized(self)
    {
        if (sharedObj == nil) {
